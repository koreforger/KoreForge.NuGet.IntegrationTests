...
| Setting | Value |
| --- | --- |
| Tag Prefix | `KoreForge.MultiApp.Settings/v` |
| Auto Increment | `minor` |
| Default Pre-release | `alpha.0` |

Example release tag: `KoreForge.MultiApp.Settings/v1.4.0`
...
```xml
<PropertyGroup>
  <MinVerTagPrefix>KoreForge.MultiApp.Settings/v</MinVerTagPrefix>
