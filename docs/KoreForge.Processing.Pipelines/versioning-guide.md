...
| Setting | Value |
| --- | --- |
| Tag Prefix | `KoreForge.Processing.Pipelines/v` |
| Auto Increment | `minor` |
| Default Pre-release | `alpha.0` |

Example release tag: `KoreForge.Processing.Pipelines/v1.4.0`
...
```xml
<PropertyGroup>
  <MinVerTagPrefix>KoreForge.Processing.Pipelines/v</MinVerTagPrefix>
